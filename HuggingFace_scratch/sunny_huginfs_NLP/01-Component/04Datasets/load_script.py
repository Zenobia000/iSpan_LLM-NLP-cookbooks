...
class CMRC2018TRIAL(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: DownloadManager):
        ...
        """
        return [datasets.SplitGenerator(name=datasets.Split.TRAIN, gen_kwargs={"filepath": "/content/drive/MyDrive/Colab_Notebooks/NLP_tutorial/Transformers 大祕寶/transformers-code/01-Getting Started/05-datasets/cmrc2018_trial.json"})]
